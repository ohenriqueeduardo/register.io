      ...
      <div className="hidden lg:flex flex-col justify-between w-1/2 bg-primary p-12 relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-lg">
          <h1 className="text-5xl font-bold text-white leading-tight mb-6">
            Comece a organizar seus registros hoje.
          </h1>
          <p className="text-xl text-white/80 leading-relaxed">
            Crie sua conta em poucos segundos e tenha acesso total ao painel administrativo mais moderno do mercado.
          </p>
        </div>
        ...
        <div className="relative z-10 flex items-center gap-4">
          <div className="flex items-center gap-2 bg-white/10 backdrop-blur-sm px-4 py-2 rounded-full border border-white/20">
            ...
            <span className="text-sm text-white font-medium">Sistema Online e Seguro</span>
          </div>
        </div>
      </div>
        ...
        <div className="w-full max-w-md space-y-8 animate-in fade-in slide-in-from-right-4 duration-700">
          ...
          <form onSubmit={handleRegister} className="space-y-5">
            ...
            <div className="flex items-start space-x-2 pt-2">
              <Checkbox id="terms" className="mt-1 rounded-md border-slate-300 data-[state=checked]:bg-primary" required />
              <label htmlFor="terms" className="text-sm text-slate-600 leading-relaxed cursor-pointer">
                Eu concordo com os <a href="#" className="font-bold text-primary hover:underline">Termos de Serviço</a> e a <a href="#" className="font-bold text-primary hover:underline">Política de Privacidade</a>.
              </label>
            </div>

            <Button 
              type="submit" 
              className="w-full h-12 rounded-xl text-base font-bold shadow-lg shadow-primary/20 gap-2 group mt-4"
              disabled={isLoading}
            >
          ...
          <div className="relative">
            ...
            <div className="relative flex justify-center text-xs uppercase">
              <span className="bg-white px-4 text-slate-400 font-medium">Ou cadastre-se com</span>
            </div>
          </div>
